...
models = dict(
    ...
    mobilenetv1_bq=dict(
        name="MobileNet",
        topic="image_classification",
        modelPath=os.path.join(root_dir, "models/image_classification_mobilenet/image_classification_mobilenetv1_2022apr_blocked.onnx"),
        topK=5,
        loadLabel=False),
    mobilenetv2=dict(
        name="MobileNet",
    ...
    mobilenetv2_bq=dict(
        name="MobileNet",
        topic="image_classification",
        modelPath=os.path.join(root_dir, "models/image_classification_mobilenet/image_classification_mobilenetv2_2022apr_blocked.onnx"),
        topK=5,
        loadLabel=False),
    ppresnet=dict(
        name="PPResNet",
    ...
    ppresnet_bq=dict(
        name="PPResNet",
        topic="image_classification",
        modelPath=os.path.join(root_dir, "models/image_classification_ppresnet/image_classification_ppresnet50_2022jan_blocked.onnx"),
        topK=5,
        loadLabel=False),
    yunet=dict(
        name="YuNet",
    ...
    yunet_bq=dict(
        name="YuNet",
        topic="face_detection",
        modelPath=os.path.join(root_dir, "models/face_detection_yunet/face_detection_yunet_2023mar_blocked.onnx"),
        topK=5000,
        confThreshold=0.3,
        nmsThreshold=0.45),
    sface=dict(
    ...
    sface_bq=dict(
        name="SFace",
        topic="face_recognition",
        modelPath=os.path.join(root_dir, "models/face_recognition_sface/face_recognition_sface_2021dec_blocked.onnx")),
    crnn_en=dict(
        name="CRNN",
    ...
    crnn_en_bq=dict(
        name="CRNN",
        topic="text_recognition",
        modelPath=os.path.join(root_dir, "models/text_recognition_crnn/text_recognition_CRNN_EN_2022oct_blocked.onnx")),
    pphumanseg=dict(
        name="PPHumanSeg",
    ...
    pphumanseg_bq=dict(
        name="PPHumanSeg",
        topic="human_segmentation",
        modelPath=os.path.join(root_dir, "models/human_segmentation_pphumanseg/human_segmentation_pphumanseg_2023mar_blocked.onnx")),
)
