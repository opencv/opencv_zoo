...
public:
    ...
    u16string postprocess(Mat outputBlob) {
        ...
        Mat character = outputBlob.reshape(1, int(outputBlob.total()));
        u16string    text(u"");
        /*
    ...
    while (waitKey(1) < 0)
    {
        ...
        if (results.first.size() > 0 && results.second.size() > 0)
        {
            ...
            for (auto box : results.first)
            {
                ...
                texts = texts + recognizer.infer(image, result);
            }
...
vector<u16string> loadCharset(string name){
    vector<u16string> CHARSET_EN_36 = {
    u"0",
    u"1",
    u"2",
    u"3",
    ...
    vector<u16string> CHARSET_CH_94 = {
    u"0",
    u"1",
    u"2",
    u"3",
    ...
    vector<u16string> CHARSET_CN_3944 = {
    u"H",
    u"O",
    u"K",
    u"I",
