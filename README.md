...
| [MP-HandPoseDet](./models/handpose_detection_mediapipe) | Hand Pose Detection           | 256x256    | ---            | ---          | ---             | ---          | ---   |
...
### Handpose Detection with [Mp-HandPoseDet](./models/handpose_detection_mediapipe/)

![handpose det](./models/handpose_detection_mediapipe/examples/mphandposedet_demo.gif)
