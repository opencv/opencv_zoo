...
parser.add_argument("--bint8", action="store_true", help="Benchmark models of blocked int8 precision only.")
...
if __name__ == '__main__':
    ...
    for cfg in cfgs:
        ...
        _model_paths = []
        if args.fp32 or args.fp16 or args.int8 or args.bint8:
            if args.fp32:
            ...
            if args.bint8:
                _model_paths += model_paths['bint8']
        else:
            _model_paths = model_paths['fp32'] + model_paths['fp16'] + model_paths['int8'] + model_paths["bint8"]
