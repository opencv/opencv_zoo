...
def cal_recall_precison_f1(gt_path, result_path, default_evaluation_params, show_result=False):
    p = {'g': gt_path, 's': result_path}
    result = rrc_evaluation_funcs.main_evaluation(p, default_evaluation_params, evaluate_method,
                                                  show_result)
